(function () {
  ...
  function replaceMenuSvg(element) {
    ...
    if (targetSvg.getAttribute("data-king-svg") === "true") {
  ...
  function replaceButtonIconSvg(element) {
    ...
    if (targetSvg && targetSvg.getAttribute("data-king-button-svg") === "true") {
      return;
    }
  ...
  function injectHiddenElementCss() {
    var style = document.querySelector('style[data-king-inline-css="true"]');
    ...
    style.setAttribute("data-king-inline-css", "true");
    style.textContent = hiddenElementCss;
  ...
  link.rel = "stylesheet";
  link.href = href;
  link.setAttribute("data-king-css", "true");
